...
def Loador():
    ...
    x_train, x_remain, y_train, y_remain = train_test_split(x, y, test_size=0.3, shuffle=True, random_state=args.random_state)
    x_valid, x_test, y_valid, y_test = train_test_split(x_remain, y_remain, test_size=0.5, shuffle=False, random_state=args.random_state)
